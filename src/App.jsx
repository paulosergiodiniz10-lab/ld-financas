      ...
      if (user) {
        ...
        unsubProfile = onSnapshot(docRef, (docSnap) => {
           ...
           if (error.code === 'permission-denied') {
              setGlobalError("Acesso Negado. O Firebase está a bloquear a leitura dos seus dados. Vá ao painel do Firebase > Firestore Database > Regras (Rules) e liberte o acesso.");
           } else {
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-lg text-center border border-red-100">
          ...
          <div className="text-sm text-slate-500 bg-slate-50 p-4 rounded-xl text-left">
             ...
             <ol className="list-decimal pl-4 mt-2 space-y-2">
                <li>Abra o Console do Firebase e vá a <b>Firestore Database</b>.</li>
                <li>Clique no separador <b>Regras (Rules)</b>.</li>
                <li>Apague o que lá está e cole este código temporário:</li>
             </ol>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
        ...
        {isTakingLong && (
          <div className="mt-4 text-sm text-slate-600 max-w-sm bg-white p-5 rounded-2xl border border-slate-200 shadow-sm animate-in fade-in slide-in-from-bottom-4">
             ...
             <p className="mb-3">Se o ecrã não sair daqui, o Google Firebase está a bloquear o seu domínio personalizado.</p>
